...
{
    // 🧭 Panel principal del admin con estadísticas y actividad real
    public function dashboard()
    {
        ...
        // 🔄 Actividad reciente (últimos registros y eventos reales)
        ...
        // Mezclar y ordenar las actividades por fecha
    ...
    public function actualizarPerfil(Request $request)
{
    ...
    // ✅ Si envía nueva imagen
    if ($request->hasFile('imagen')) {
        $imagen = $request->file('imagen');
        $nombreImagen = time() . '_' . $imagen->getClientOriginalName();
        $imagen->storeAs('public/usuarios', $nombreImagen);

        // Elimina la imagen anterior si existía
        if ($admin->imagen) {
            Storage::delete('public/usuarios/' . $admin->imagen);
        }
