                    ...
                    @foreach($alquileres as $alquiler)
                        ...
                        @if($editId == $alquiler->id)
                            <form action="{{ route('admin.alquileres.update', $alquiler->id) }}" method="POST">
                                ...
                                <tr>
                                    <td>{{ $alquiler->id }}</td>
                                    <td>{{ optional($alquiler->usuario)->nombre ?? 'Cliente eliminado' }}</td>
                                    <td>{{ optional($alquiler->disfraz)->nombre ?? 'Disfraz eliminado' }}</td>
                        ...
                        @else
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{{ route('admin.alquileres.destroy', $alquiler->id) }}"
                                          class="d-inline" onsubmit="return confirm('¿Seguro que deseas eliminar este alquiler?');">
                                        @csrf
                                        @method('DELETE')
