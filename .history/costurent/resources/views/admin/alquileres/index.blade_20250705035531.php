...
<div class="container mt-5">
    ...
    <form method="GET" action="{{ route('admin.alquileres.index') }}" class="mb-3">
        <div class="input-group">
            <input type="text" name="search" class="form-control" placeholder="Buscar por nombre del cliente" value="{{ request('search') }}">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="disfraz_id" class="form-select" required>
                            ...
                            @foreach($disfraces as $d)
                                <option value="{{ $d->id }}">{{ $d->nombre }} (S/.{{ number_format($d->precio, 2) }})</option>
                            @endforeach
                        </select>
                    </div>
