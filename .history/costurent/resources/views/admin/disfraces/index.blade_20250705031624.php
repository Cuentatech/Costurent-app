...
function toggleForm(which = null) {
    ...
    if (which === 'disfraz') document.getElementById('form-disfraz').classList.remove('d-none');
    if (which === 'categoria') document.getElementById('form-categoria').classList.remove('d-none');
}
