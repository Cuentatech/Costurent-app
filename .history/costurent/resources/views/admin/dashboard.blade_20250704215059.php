...
<div class="content-card quick-actions-card">
    ...
    <div class="card-body">
        <div class="quick-actions-grid">
            {{-- Nuevo Cliente --}}
            <a href="{{ route('admin.clientes.create') }}" class="quick-action-item">
            ...
            {{-- Crear Alquiler --}}
            <a href="{{ route('admin.alquileres.create') }}" class="quick-action-item">
                <div class="quick-action-icon">
                    <i class="bi bi-plus-square"></i>
                </div>
                <div class="quick-action-content">
                    <h4>Crear Alquiler</h4>
                    <p>Registrar un nuevo alquiler</p>
                </div>
            </a>

            {{-- Agregar Disfraz --}}
            <a href="{{ route('admin.disfraces.create') }}" class="quick-action-item">
                <div class="quick-action-icon">
                    <i class="bi bi-graph-up"></i>
                </div>
                <div class="quick-action-content">
                    <h4>Agregar Disfraz</h4>
                    <p>Añade un nuevo disfraz al inventario</p>
                </div>
            </a>
        </div>
    </div>
