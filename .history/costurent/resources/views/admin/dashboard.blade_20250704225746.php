        ...
        <div class="card shadow-sm mb-5 animate__animated animate__fadeInUp">
            ...
            <div class="card-body">
                <div class="row g-4 text-center">
                    ...
                    {{-- Nuevo Cliente --}}
                    <div class="col-md-4">
                        <a href="{{ route('admin.clientes.index') }}" class="btn btn-outline-primary w-100 py-4">
                            <i class="bi bi-person-plus fs-3"></i>
                            <div class="fw-semibold mt-2">Nuevo Cliente</div>
                        </a>
                    </div>

                    {{-- Crear Alquiler (va a index porque no tienes ruta create explícita) --}}
                    <div class="col-md-4">
                        <a href="{{ route('admin.alquileres.index') }}" class="btn btn-outline-success w-100 py-4">
                            <i class="bi bi-plus-square fs-3"></i>
                            <div class="fw-semibold mt-2">Crear Alquiler</div>
                        </a>
                    </div>

                    {{-- Agregar Disfraz --}}
                    <div class="col-md-4">
                        <a href="{{ route('admin.disfraces.index') }}" class="btn btn-outline-warning w-100 py-4">
                            <i class="bi bi-person-badge-fill fs-3"></i>
                            <div class="fw-semibold mt-2">Agregar Disfraz</div>
                        </a>
                    </div>
                </div>
            </div>
