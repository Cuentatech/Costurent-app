        ...
        <div class="card shadow-sm mb-5 animate__animated animate__fadeInUp">
            ...
            <div class="card-body">
                <div class="row g-4 text-center">
                    ...
                    {{-- Nuevo Cliente --}}
                    <div class="col-md-4">
                        <a href="{{ route('admin.clientes.create') }}" class="btn btn-outline-primary w-100 py-4">
                    ...
                    {{-- Agregar Disfraz --}}
                    <div class="col-md-4">
                        <a href="{{ route('admin.disfraces.create') }}" class="btn btn-outline-warning w-100 py-4">
