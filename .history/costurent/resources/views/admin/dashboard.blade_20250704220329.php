        ...
        <div class="card shadow-sm mb-5 animate__animated animate__fadeInUp">
            ...
            <div class="card-body">
                <div class="row g-4">
                    ...
                    {{-- Nuevo Cliente --}}
                    <div class="col-md-4">
                        <div class="card h-100 border-primary shadow-sm hover-shadow text-center">
                            <div class="card-body">
                                <a href="{{ route('admin.clientes.create') }}" class="text-decoration-none text-primary d-flex flex-column align-items-center">
                                    <i class="bi bi-person-plus display-4 mb-2"></i>
                                    <h5 class="fw-bold mb-1">Nuevo Cliente</h5>
                                    <p class="text-muted mb-0">Agregar un nuevo cliente</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- Crear Alquiler --}}
                    <div class="col-md-4">
                        <div class="card h-100 border-success shadow-sm hover-shadow text-center">
                            <div class="card-body">
                                <a href="{{ route('admin.alquileres.index') }}" class="text-decoration-none text-success d-flex flex-column align-items-center">
                                    <i class="bi bi-plus-square display-4 mb-2"></i>
                                    <h5 class="fw-bold mb-1">Crear Alquiler</h5>
                                    <p class="text-muted mb-0">Registrar un nuevo alquiler</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- Agregar Disfraz --}}
                    <div class="col-md-4">
                        <div class="card h-100 border-warning shadow-sm hover-shadow text-center">
                            <div class="card-body">
                                <a href="{{ route('admin.disfraces.create') }}" class="text-decoration-none text-warning d-flex flex-column align-items-center">
                                    <i class="bi bi-person-badge-fill display-4 mb-2"></i>
                                    <h5 class="fw-bold mb-1">Agregar Disfraz</h5>
                                    <p class="text-muted mb-0">Añadir nuevo disfraz al sistema</p>
                                </a>
                            </div>
                        </div>
                    </div>
