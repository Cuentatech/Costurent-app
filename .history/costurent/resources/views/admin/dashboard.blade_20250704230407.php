...
.quick-action-link:hover .action-icon::after {
    width: 100%;
    height: 100%;
}
...
.quick-action-link.primary .action-icon {
    background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
...
.quick-action-link.success:hover {
    background: linear-gradient(135deg, #10b981 0%, #34d399 100%);
    color: white;
}

.quick-action-link.success .action-icon {
    background: linear-gradient(135deg, #10b981 0%, #34d399 100%);
...
.quick-action-link.warning:hover {
    background: linear-gradient(135deg, #f59e0b 0%, #fbbf24 100%);
    color: white;
}

.quick-action-link.warning .action-icon {
    background: linear-gradient(135deg, #f59e0b 0%, #fbbf24 100%);
    box-shadow: 0 8px 16px rgba(245, 158, 11, 0.4);
}

.quick-action-link.primary:hover .action-text,
.quick-action-link.success:hover .action-text,
.quick-action-link.warning:hover .action-text {
    color: white;
}

.quick-action-link.primary:hover .action-arrow,
.quick-action-link.success:hover .action-arrow,
.quick-action-link.warning:hover .action-arrow {
